...
//            CommentDto dto = CommentDto.createCommtentDto(c);
//            dtos.add(dto);
//        }
//        // 반환
        return commentRepository.findByArticleId(articleId)
                .stream()
                .map(comment -> CommentDto.createCommtentDto(comment))
    ...
    public CommentDto create(Long articleId, CommentDto dto) {
        ...
        return CommentDto.createCommtentDto(created);
    ...
    public CommentDto update(Long id, CommentDto dto) {
        ...
        return CommentDto.createCommtentDto(updated);
    }
    @Transactional
    public CommentDto delete(Long id) {
        ...
        // 삭제 댓글을 DTO로 변환
        return CommentDto.createCommtentDto(target);
    }
}
